...
public class CharacterSheetScreen extends AbstractContainerScreen<CharacterSheetMenu> {
	...
	private void syncFromEntity() {
		...
		int xpLevel = entity.experienceLevel;
	...
	private void initMainPanel() {
		...
		level = new EditBox(this.font, this.leftPos + PROF_OFFSET_X + 40, this.topPos + PROF_OFFSET_Y, 20, 18, Component.translatable("gui.dndsheets.character_sheet.level"));
		level.setMaxLength(2);
		guistate.put("text:level", level);
		this.addWidget(this.level);

		hunger = new EditBox(this.font, this.leftPos + ACHP_OFFSET_X + ACHP_SEPARATION*4 + 40, this.topPos + ACHP_OFFSET_Y, 24, 18, Component.translatable("gui.dndsheets.character_sheet.hunger"));
		...
		hitPointsMax.setEditable(false);
		hitPointsTemp.setEditable(false);
